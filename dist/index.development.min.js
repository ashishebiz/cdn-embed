"use strict";var IdentityVerificationCDN=(()=>{var c=(e,n,t)=>new Promise((o,r)=>{var A=a=>{try{p(t.next(a))}catch(g){r(g)}},b=a=>{try{p(t.throw(a))}catch(g){r(g)}},p=a=>a.done?o(a.value):Promise.resolve(a.value).then(A,b);p((t=t.apply(e,n)).next())});var f="https://develop-api.chainit.online",x="/rule-engine/v1/age-app-embed/generate-qr",y="/rule-engine/v1/age-app-embed/get-qr";var L="#embed-qr-code",E="#embed-qr-code-logs",S=5e3,m=1e4,i={WaitingForScan:"WaitingForScan",Timeout:"Timeout",Scanned:"Scanned",Approved:"Approved",RejectedByUser:"RejectedByUser",RejectedByRequirement:"RejectedByRequirement",SomethingWentWrong:"SomethingWentWrong"};function R(t){return c(this,arguments,function*(e,n={}){let o=yield fetch(e,{method:"GET",headers:n});if(!o.ok)throw new Error(`HTTP error ${o.status}`);return o.json()})}var v=e=>({Timeout:`
